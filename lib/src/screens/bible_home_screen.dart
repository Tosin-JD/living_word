      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            const SizedBox(width: 16), // Fixed small space between the texts
            Text(
            ...
            children: [
                  ...
                  builder: (context) {
                    ...
                    return GestureDetector(
                      ...
                      onScaleEnd: (details) {
                        ...
                        final finalSize = ref.read(fontSizeProvider);
              ...
              FutureBuilder<bool>(
                ...
                builder: (context, snapshot) {
                  ...
                  return hasNavBar ? SafeArea(top: false, child: child) : child;
                },
              ),
            ],
          ),
